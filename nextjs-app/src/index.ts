...
export interface HyperliquidConfig {
  ...
  /** Custom referral code to set automatically when first order is placed. If not provided, SDK default will be used. */
  referralCode?: string;
  /** Disable automatic referral code setting. If true, referral code will not be set automatically. */
  disableAutoReferral?: boolean;
}
